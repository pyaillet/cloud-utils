...
resource "google_compute_subnetwork" "rke-network-sub0" {
  name          = "rke-network-sub0"
...
resource "google_compute_firewall" "internal" {
  name    = "rke-network--allow-internal"
  network = "${google_compute_network.rke-network.name}"
...
resource "google_compute_firewall" "external" {
  name    = "rke-network--allow-external"
  network = "${google_compute_network.rke-network.name}"
...
resource "google_compute_instance" "worker" {
  ...
  network_interface {
    subnetwork = "${google_compute_subnetwork.rke-network-sub0.self_link}"
